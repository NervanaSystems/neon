  ...
  int outC, int outH, int outW)
{
	...
	dnnLayout_t lt_in_NCHW,    lt_filter,         lt_out_NCHW,   lt_in_CHWN, lt_out_CHWN;
	dnnLayout_t lt_in_f,       lt_filter_f,       lt_out_f;
	dnnLayout_t lt_in_bdata,   lt_filter_bdata,   lt_out_bdata;
    dnnLayout_t lt_in_bfilter, lt_filter_bfilter, lt_out_bfilter;
