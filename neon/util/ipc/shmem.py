...
class Message(object):
    """
    A class to contain messages to pass between server and client
    The content of the message is a struct containing the header, and data etc.
    fields

    Arguments:
        suffix (str): unique shared memory segment name suffix
        header_format (str): format used to packed and unpacked the header
                             into the messages
...
class Endpoint(object):
    """
    The endpoint class that server and client will extend based on
    Contains requenst and reponse messages
    """
...
class Server(Endpoint):
    """
    A class extended for Server end
    """
    def __init__(self, **kwargs):
...
class Client(Endpoint):
    """
    A class extended for Client end
    """
    def __init__(self, **kwargs):
    ...
    def receive_buf(self):
        return self.response.receive_buf()
